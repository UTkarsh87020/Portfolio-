...
export const PROJECTS: IProject[] = [
    {
        title: 'FastTrack Delivery', slug: 'fasttrack-delivery', year: 2026,
        techStack: ['HTML5', 'CSS3', 'JavaScript', 'Node.js', 'Express.js'],
        thumbnail: '/projects/thumbnail/fasttrack-delivery.webp', longThumbnail: '/projects/long/fasttrack-delivery.webp', images: [],
    ...
    {
        title: 'Dynamic Music Player Web App', slug: 'dynamic-music-player', year: 2025,
        techStack: ['HTML5', 'CSS3', 'Vanilla JavaScript'],
        thumbnail: '/projects/thumbnail/dynamic-music-player.webp', longThumbnail: '/projects/long/dynamic-music-player.webp', images: [],
